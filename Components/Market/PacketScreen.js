...
export default class PacketScreen extends Component {
  ...
  _getItem () {
    ...
    fetch ('http://192.168.0.7:8080/api_sepatu/getPembelian.php', {
      method: 'POST',
      header: {
                  ...
                  body={
                    <View style={{flex: 1, flexDirection: 'row'}}>
                      <View style={{flex: 3.3, flexWrap: 'wrap'}}>
                        <Text style={{color: 'black', paddingBottom:3}}>{items.nama_barang}</Text>
                        <Text style={{color: 'black'}}>{items.id_pembelian}</Text>
                      </View>
                      <View style={{flex: 3}}>
                        <Text style={{color: 'black',paddingBottom:3}}>Status</Text>
                      ...
                      >
                      {
                        ...
                        items.status_pembelian=='0'?(
                          <TouchableOpacity onPress={() => navigate('Transaksi',{
...

                      {
                        ...
                        items.status_pembelian=='1'?(
                          <TouchableOpacity onPress={() => navigate('Transaksi1',{
                            id_pembelian: items.id_pembelian,
                            id_barang: items.id_barang,
                            nama_barang: items.nama_barang,
                            harga: items.harga,
...

                      {
                        ...
                        items.status_pembelian=='2'?(
                          <TouchableOpacity onPress={() => navigate('Penerima',{
                            id_pembelian: items.id_pembelian,
                            id_barang: items.id_barang,
                            nama_barang: items.nama_barang,
                            user_id: items.user_id,
