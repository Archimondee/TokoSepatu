...
export default class PenerimaScreen extends Component {
  constructor (props) {
    super (props);
    this.state = {
  ...
  _submit = () => {
    ...
    fetch ('http://192.168.0.7:8080/api_sepatu/changeStatusOrd.php', {
      method: 'POST',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json',
                  ...
                  return (
                    ...
                    >
                      <Item>
                        <Input
                          disabled
                          onChangeText={no_rek => this.setState ({no_rek})}
                      ...
                      <Item>
                        <Input
                          disabled
                          onChangeText={nama_rek => this.setState ({nama_rek})}
                      ...
                      <Item>
                        <Input
                          disabled
                          onChangeText={bank_rek => this.setState ({bank_rek})}
